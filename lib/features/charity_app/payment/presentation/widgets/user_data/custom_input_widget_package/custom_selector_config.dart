...
class CustomSelectorConfig {
  ...
  final CustomPhoneInputSelectorType selectorType;
  ...
  /// Creates a new [CustomSelectorConfig] with the specified options.
  ///
  ...
  const CustomSelectorConfig({
    this.selectorType = CustomPhoneInputSelectorType.DROPDOWN,
    this.showFlags = true,
    this.useEmoji = false,
