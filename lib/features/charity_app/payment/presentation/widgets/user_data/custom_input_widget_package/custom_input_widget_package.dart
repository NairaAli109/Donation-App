...
import 'package:donation_app/features/charity_app/payment/presentation/widgets/user_data/custom_input_widget_package/custom_selector_button.dart';
...
///   * [CustomPhoneInputSelectorType.DROPDOWN]
///   * [CustomPhoneInputSelectorType.BOTTOM_SHEET]
///   * [CustomPhoneInputSelectorType.DIALOG]
enum CustomPhoneInputSelectorType { DROPDOWN, BOTTOM_SHEET, DIALOG }
...
/// * [CustomPhoneInputSelectorType] for available selector display modes
class CustomInternationalPhoneNumberInput extends StatefulWidget {
  ...
  final CustomSelectorConfig selectorConfig;
  ...
  CustomInternationalPhoneNumberInput({
    Key? key,
    this.selectorConfig = const CustomSelectorConfig(),
          ...
          children: [
            Container(
              decoration: BoxDecoration(
                ...
                border: const Border(
                  top: BorderSide(color: AppColors.grey2, width: 1),
                  right: BorderSide(color: AppColors.grey2, width: 1),
                  bottom: BorderSide(color: AppColors.grey2, width: 1),
              ...
              child: Row(
                children: [
                  ...
                  CustomSvgIcon(assetName: Assets.iconsArrowDownIcon),
